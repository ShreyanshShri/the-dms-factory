		...
		try {
			...
			if (response.success) {
				...
				setFormData({
					...
					newLeads: "", // Always empty for new leads only
		...
		<div className="campaign-edit-container">
			...
			{isActiveCampaign && (
				<div className="campaign-status-warning">
					...
					<p>
						Some settings cannot be modified while the campaign is running. You
						can still update basic information, working hours, and add new
						leads.
					</p>
				</div>
			)}
			...
			{successMessage && (
				<div
					className={`campaign-success-message ${successMessage ? "show" : ""}`}
				>
					✓ {successMessage}
				</div>
			)}
			...
			<form className="campaign-edit-form" onSubmit={handleSubmit}>
				...
				{/* Leads Management */}
				<div className={`campaign-edit-section ${isActiveCampaign ? "" : ""}`}>
					<h2>Leads Management</h2>

					<div className="campaign-leads-info">
						<h4>📍 Lead Management Policy</h4>
						<p>
							You can add new leads to expand your campaign reach, but existing
							leads cannot be removed to maintain campaign integrity and prevent
							data complications.
						</p>
					</div>
					...
					<div className="campaign-form-group">
						...
						/>
						<div className="campaign-form-help">
							Enter usernames one per line. The @ symbol is optional and will be
							removed automatically. Only new leads will be added - duplicates
				...
				<div className="campaign-edit-section">
					...
					<div className="campaign-form-help">
						Set the hours when the campaign should be active. Messages will only
						be sent during these hours.
					</div>
				</div>
				...
				<div className="campaign-edit-section">
					...
					<div className="campaign-form-help">
						Set daily limits for message sending to avoid being flagged as spam.
					</div>
				</div>
				...
				<div className="campaign-edit-section">
					...
					<div className="campaign-form-checkboxes">
						<div className="campaign-checkbox-group">
							...
							/>
							<label htmlFor="followUser">Follow users before messaging</label>
						</div>
