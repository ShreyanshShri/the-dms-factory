...
const ContactMe: React.FC = () => {
	...
	const contactMethods = [
		...
		},
		{
			...
			icon: Mail,
			value: "hdmedia0525@gmail.com",
			action: "mailto:hdmedia0525@gmail.com",
			status: "active",
		...
		// },
		{
			...
			action: "https://whop.com/thebuildfluence",
			status: "active",
		...
		},
		{
			...
			icon: Calendar,
			value: "Book a Call",
			action: "https://calendly.com/buildfluence",
			status: "active",
